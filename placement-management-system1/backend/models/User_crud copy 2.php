...
class User
{
    ...
    public function updateProfile($id, $firstName, $lastName, $fullName, $rollNo, $branch, $completedYear, $phone, $location, $resume_path, $cgpa, $backlogs, $twelfth, $tenth, $github, $linkedin)
    {
        ...
        if ($resume_path !== null) {
            $sql = "
                    UPDATE users u,student_profiles sp
                    SET
                    ...
                    sp.Branch=:branch,
                    sp.completed_year=:completed_year,
                    sp.current_location=:location,
                    sp.resume_path=:resume,

                    sp.cgpa=:cgpa,
                    sp.backlogs=:backlogs,
                    sp.tenth=:tenth,
                    sp.twelfth=:twelfth,
                    sp.github=:github,
                    sp.linkedin=:linkedin

                    WHERE u.id=sp.user_id AND u.id=:id
                    ";
                } else {
                        $sql = "
                                UPDATE users u,student_profiles sp
        ...
        $query->bindParam(":backlogs", $backlogs);
        $query->bindParam(":twelfth", $twelfth);
        $query->bindParam(":tenth", $tenth);
